...
<div align="center">
  ...
  <p align="center">
   <em>Internet Relay Chat</em><br/>
    A C++ project to reproduce the behavior of an IRC server  (ft. <a href="https://github.com/laird-ikar">bguyot</a>)
    <br />
    <br />
...
This project aims to reproduce the behavior of a real IRC server in C++ 98. It's a group project i made it with <a href="https://github.com/laird-ikar">bguyot</a>.
